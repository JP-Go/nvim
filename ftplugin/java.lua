...
local jdtls_install_location = vim.fn.expand('$HOME') .. '/.local/share/nvim/mason/packages/jdtls'
...
local workspace_dir = vim.fn.expand('$HOME') .. '/.java/workspaces/' .. vim.fn.fnamemodify(vim.fn.getcwd(), ':p:h:t')
